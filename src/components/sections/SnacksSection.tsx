    ...
    <section className="py-16 md:py-20 bg-cream">
      <div className="container-custom mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <h2 className="section-title mt-2">{title || "Traditional Snacks"}</h2>
          <p className="section-subtitle">{subtitle || "Crispy murukulu, chekkalu and more — straight from the kadai."}</p>
        </div>
